        ...
        <Col>
          <Card>
            <CardBody>
              ...
              <h5 style={{ color: "#ec6735" }}>
                <strong>{appointment?.person?.vorname}</strong>, wir freuen uns
                Dich schon bald in unserer Praxis begrüßen zu dürfen!
              </h5>
              {appointment.dest != "erkrath" && (
                <p style={{ marginTop: "30px" }}>
                  <h6>
                    Wichtig! <br />
                    Bitte Fragebogen herunterladen und ausgefüllt mitbringen!
                  </h6>
                  Für Deinen ersten Besuch bei uns benötigen wir den von Dir
                  ausgefüllten Fragebogen.
                  <br />
                  Wenn Du keinen Drucker hast, um den Fragebogen vorab
                  auszufüllen, komme bitte
                  <span style={{ color: "#ec6735", fontWeight: "bold" }}>
                    {" "}
                    15 Minuten vor Deinem Termin
                  </span>{" "}
                  zu uns in die Praxis. Hier kannst Du Deinen Fragebogen in Ruhe
                  ausfüllen.
                  <br />
                  Wenn vorhanden, bringe bitte MRTs, Röntgenbilder, Vorbefunde
                  und Diagnosen mit.
                </p>
              )}
                ...
                <ButtonGroup>
                  <ICalendarLink event={event}>
                    <Button color="primary" style={{ marginRight: "20px" }}>
                      <BsCalendarDay /> Termin im Kalender eintragen
                    </Button>
                  </ICalendarLink>
                  {appointment.dest != "erkrath" && (
                    <Button
